...
const DEFAULT_GLOW_COLOR = '180, 0, 255'; // Your primary purple/pink color
...
const GlobalSpotlight = ({
  ...
  useEffect(() => {
    ...
    // Removed visible spotlight element - keeping only card glow effects
    const handleMouseMove = (e: MouseEvent) => {
...
export { MagicBento, ParticleCard };
